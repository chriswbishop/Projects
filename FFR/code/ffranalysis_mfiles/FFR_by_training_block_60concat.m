function FFR_by_training_block_60concat ( fileName )
...
block_max = 3; % 360 epochs/60 epochs per block =  6 blocks, 3 if concatenated
...
% Trim to first 360 epochs, Concatenate consecutive epochs and get FFT data
...
% plot_indexY = 1;
plot_width = 1.5;
figure('Name',[fileName '--FFRx360 trials concatenated'] , 'Units', 'inches', 'Position', [ 1 1 10.5 6]);
