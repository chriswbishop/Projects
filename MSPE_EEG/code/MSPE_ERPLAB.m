function results=MSPE_ERPLAB(args)
%% DESCRIPTION
%
% INPUTS:
%
...
% try 
    %% ERPLAB: Filter EEG
    EEG = pop_basicfilter( EEG, args.chanArray, args.FilterBandPass(1), args.FilterBandPass(2), args.FilterOrder, args.typef, 1, args.boundary );
