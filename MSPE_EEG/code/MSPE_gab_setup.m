function jobs = MSPE_gab_setup(sid, EXPID)
%% DESCIRPTION
%
%   General setup file for Study 26 (MSPE_EEG)
%
% INPUT:
%   
...
studyDir=['/home/cwbishop/projects/MSPE/' EXPID '/'];
% studyDir=['/home/cwbishop/projects/MSPE/'];
...
%   to the 'behavior' directory, etc.  
    ...
    unpack.task{end+1}=struct(...
        ...
        'args',struct(...
            ...
            'destination',{{fullfile(subDir, 'eeg'), fullfile(subDir,'behavior'), fullfile(subDir, 'eyetracking')}},...
            'filter',{{['*' SID '*.bdf'], ['*' SID '*.log'], [SID '*.edf']}}, ...
            'directories', {{fullfile(subDir, 'eeg'), fullfile(subDir,'behavior'), fullfile(subDir, 'eyetracking')}}));
    
%% PREPROCESSING (preproc)
%
%   This job does some basic prerpocessing including importing data
%   into EEGLAB, merging files (if necessary), high-pass filtering the
%   data, loading electrode locations, etc.  It requires that the
%   'unpack' job be complete before it will successfully execute. 
    ...
    preproc.task{end+1}=struct(...
        ...
        'args',struct(...
            'file',fullfile(subDir, 'eeg', [SID '-MSPE.bdf']),...
