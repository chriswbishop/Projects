function [ASTIM FS LEDo LEDs]=MSPE_stim(IN, DATA, FS, D, R, WRITE)
%% DESCRIPTION:
%   
...
%
%   LEDo:
%       Integer, sample number where VCOD is embedded.   
%
%   LEDs:
%       String, code embedded in WAV file.
%
%   Note:
...
if ~exist('D', 'var') || isempty(D), D=.015; end % D %%%
if ~exist('R', 'var') || isempty(R), R=.0005; end % R %%%
